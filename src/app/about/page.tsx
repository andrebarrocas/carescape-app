    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-24">
        <div className="max-w-5xl w-full mx-auto text-left">
          ...
          <div className="flex flex-nowrap justify-between gap-2 mb-12 w-full mx-auto">
            <div className="flex flex-col items-center text-center flex-1">
              <div className="w-full h-48 flex-shrink-0 mb-4 flex items-center justify-center">
                <Image 
                  src="/desenho-1.gif" 
                  alt="About visual 1" 
                  width={256} 
            ...
            <div className="flex flex-col items-center text-center flex-1">
              ...
              <h2 className="text-xl font-bold mb-2 text-black font-mono">Shared Networks of Care</h2>
